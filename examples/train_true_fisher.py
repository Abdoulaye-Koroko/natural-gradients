...
def train(args):
    ...
    for epoch in range(args.num_epochs):
        ...
        for iter,batch in enumerate(trainloader):
            ...
            index = np.random.randint(low=0, high=args.batch_size, size=args.batch_size//4) # fisher_batch_size is the size of the batch used to compute the curvature matrix
